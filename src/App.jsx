  ...
  return (
    <div className="rounded-2xl border bg-white p-4 shadow-sm flex flex-col">
      ...
      <div className="mt-3 text-sm">
        <span className="inline-flex items-center rounded-full bg-amber-50 px-3 py-2 font-medium text-amber-900 ring-1 ring-amber-200">
          비용: {item.price || ""}
        </span>
      </div>
      ...
      <div className="mt-4 flex items-center justify-between">
        <Link
          to={`/cases/${item.id}`}
          className="rounded-lg bg-amber-500 px-3 py-2 text-xs font-semibold text-white shadow hover:bg-amber-600"
        >
          자세히 보기
        </Link>
