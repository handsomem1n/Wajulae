...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 요청ID | 타임스탬프 | 고객명 | 연락처 | 작업형태 | 사진 | (빈칸) | 주소 | 세부주소 | 희망날짜 | 희망시간 | 매칭상태 | 매칭된기사 | 매칭시각 |
| REQ-20250111-001 | 2025-01-11 14:30 | 홍길동 | 010-1234-5678 | 콘센트 교체 | http://... | | 서울시... | 102동 101호 | 2025-01-15 | 오전 | 대기중 | | |

**중요:**
- A열: 요청ID (Apps Script가 자동 생성)
- L열: 매칭상태 ("대기중", "매칭완료")
- M열: 매칭된 기사 (수락한 기사 이름)
- N열: 매칭 시각 (자동 기록)
...
⚠️ **주의:** 실제 시트 구조에 맞게 열 번호를 조정해야 합니다!
